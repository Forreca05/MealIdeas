                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SCAN_FOOD_PAGE_Button_k9ltjbzr_ON_TAP');
                        ...
                        _model.api = await BarcodeCallCall.call(
                          valueBarCode: _model.barCodeValue,
                        );

                        if ((_model.api?.succeeded ?? true)) {
                          logFirebaseEvent('Button_update_page_state');
                          _model.scantitle = BarcodeCallCall.productname(
                            (_model.api?.jsonBody ?? ''),
                          );
                          safeSetState(() {});
                        } else {
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Erro ao Comunicar com a API'),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                      ...
                      text: valueOrDefault<String>(
                        _model.scantitle,
                        'Click Where to Scan your Products',
                      ),
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('SCAN_FOOD_PAGE_Row_tc0081kz_ON_TAP');
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SCAN_FOOD_ADD_IT_TO_MY_INGREDIENT_LIST_B');
                        logFirebaseEvent('Button_haptic_feedback');
                        HapticFeedback.lightImpact();
                        if (_model.scantitle != null &&
                            _model.scantitle != '') {
                          if (_model.datePicked != null) {
                            ...
                            logFirebaseEvent('Button_update_page_state');
                            _model.scantitle =
                                'Click to Scan your Next Product ';
                            safeSetState(() {});
                          } else {
                      ...
                      text: 'Add it to my Ingredient List',
                      options: FFButtonOptions(
                        width: double.infinity,
                        height: 50.0,
                        padding:
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'SCAN_FOOD_PAGE_ADD_MANUALLY_BTN_ON_TAP');

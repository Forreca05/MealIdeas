...
class _AddIngredientWidgetState extends State<AddIngredientWidget> {
  ...
  void initState() {
    ...
    _model.ingNameTextController ??= TextEditingController();
    _model.ingNameFocusNode ??= FocusNode();
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADD_INGREDIENT_arrow_back_rounded_ICN_ON');
          ...
          child: Stack(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.ingNameTextController,
                        focusNode: _model.ingNameFocusNode,
                        autofocus: false,
                        ...
                        validator: _model.ingNameTextControllerValidator
                            .asValidator(context),
                        inputFormatters: [
                          if (!isAndroid && !isiOS)
              ...
              Align(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('ADD_INGREDIENT_PAGE_expire_ON_TAP');
                    logFirebaseEvent('expire_date_time_picker');
